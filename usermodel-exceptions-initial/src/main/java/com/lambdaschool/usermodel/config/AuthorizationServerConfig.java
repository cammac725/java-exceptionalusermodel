...
// Authorization - authorize clients(app) to access => client id / client secret
// Authorization - authorize users => username / password
// Restrict resources
// Access Token is returned - identifies the user
//
// Authorization Server
// Security Config - pw encryption, token location, authorization/authentication
// Resource Server - who has access to what - changes the most
